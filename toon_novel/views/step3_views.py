...
def eng_show():
    if request.method=='POST':
        ...
        def summarization(trans_genre, trans_character, trans_plot, text_input):
            ...
            messages = [
                        {"role": "system", "content": f"Please extract the key points from {trans_plot} based on {text_input} from {trans_character}'s perspective, you don't need to include the entire plot summary"},
        ...
        result = summarization(trans_genre, trans_character, trans_plot, trans_text_input)
